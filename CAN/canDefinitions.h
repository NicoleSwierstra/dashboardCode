...
const char* MC_Post_Errors[32] = {
    ...
    "DC Bus Voltage High", //why is this backwards? thanks, cascadia! 
    "DC Bus Voltage Low",
    "Pre-Charge Timeout",
...
struct MC_FaultCodes {
    uint32_t            postErrors;
    uint32_t            runtimeErrors;
};

struct MC_TorqueTimer {
